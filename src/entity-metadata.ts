...
function structuralTypeFromJson(metadataStore: MetadataStore, json: any, allowMerge: boolean) {
  ...
  let config = {
    ...
    autoGeneratedKeyType: AutoGeneratedKeyType.instance.fromName(json.autoGeneratedKeyType),
...
/**
  ...
  @final
  **/
export class AutoGeneratedKeyType extends TypedEnum<AutoGeneratedKeyTypeSymbol> {
  static instance = new AutoGeneratedKeyType();
  constructor() {
  ...
  @static
  **/
  static None = AutoGeneratedKeyType.instance.addSymbol();
  /**
  ...
  @static
  **/
  static Identity = AutoGeneratedKeyType.instance.addSymbol();
  /**
  ...
  @static
  **/
  static KeyGenerator = AutoGeneratedKeyType.instance.addSymbol();

};
AutoGeneratedKeyType.instance.resolveSymbols();
