...
import { MetadataStore, EntityType, ComplexType, DataProperty, NavigationProperty, AutoGeneratedKeyType, AutoGeneratedKeyTypeSymbol } from './entity-metadata';
...
export class EntityManager {
  ...
  **/
  importEntities(exportedString: string | Object, importConfig?: { mergeStrategy?: MergeStrategySymbol, metadataVersionFn?: (arg: { metadataVersion: any, metadataStoreName: any }) => void }) {
    ...
    importConfig.tempKeyMap = tempKeyMap;
  ...
  **/
  fetchMetadata(dataService?: DataService, callback?: Function, errorCallback?: Function) {
  ...
  @return {Promise}
    ...
    would have been applied.
  **/
  executeQuery(query: EntityQuery, callback?: Function, errorCallback?: Function) {
...
**/
  ...
  **/
  ...
  private _updateFkVal(fkProp, oldValue, newValue) {
...
function importEntityGroup(entityGroup, jsonGroup, config) {
  ...
  let entityType = entityGroup.entityType;
  let mergeStrategy = config.mergeStrategy;
