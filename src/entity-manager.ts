...
import { EntityAspect, IEntity, IComplexObject, IStructuralObject } from './entity-aspect';
...
import { QueryOptions, MergeStrategy, MergeStrategySymbol, FetchStrategy } from './query-options';
